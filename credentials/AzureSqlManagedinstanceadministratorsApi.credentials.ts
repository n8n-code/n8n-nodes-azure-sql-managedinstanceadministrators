...
export class AzureSqlManagedinstanceadministratorsApi implements ICredentialType {
	name = 'N8nDevAzureSqlManagedinstanceadministratorsApi';

	displayName = 'Azure SQL Managedinstanceadministrators API';

	icon: Icon = { light: 'file:../nodes/AzureSqlManagedinstanceadministrators/azure-sql-managedinstanceadministrators.png', dark: 'file:../nodes/AzureSqlManagedinstanceadministrators/azure-sql-managedinstanceadministrators.dark.png' };
	...
	properties: INodeProperties[] = [
		{
			...
			description: 'The base URL of your Azure SQL Managedinstanceadministrators API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
